##
## get-officeinstallpath.ps1 の元ネタ
##

Function Get-RemoteOfficeVersion {
    <#
    .Synopsis
    ...
    process {
        ...
        foreach ($computer in $ComputerNames) {
            if ($Credentials -and $computer -ne "." -and $computer -ne "localhost") {
...
$OfficeVersions = Get-RemoteOfficeVersion -ComputerNames $ComputerNames -Credentials $Credentials
